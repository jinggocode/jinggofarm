    ...
    <div class="container py-5 mt-3">
      <div class="row">
        <div class="col-md-12 text-white">
          <h1 class=" mb-4 text-center">Daftar Investasi di <b>Jinggofarm</b></b></h1>
    ...
    <div class="container">
      <div class="row">
        ...
        @foreach($ternak as $value)
          <div class="col-md-4 my-3 card-fit" onclick="window.location.href='{{site_url('investor/cattle/view/'.$value->id.'/'.$value->slug)}}'" style="cursor: pointer;">
            <div class="card-deck">
              <div class="card card-hover border-secondary">
                ...
                <div class="card-footer">
                  <a href="{{site_url('investor/cattle/view/'.$value->id.'/'.$value->slug)}}" class="card-link btn btn-block btn-success"><i class="fa fa-eye"></i> Lihat Selengkapnya</a>
                </div>
              </div>
            </div>
          </div>
