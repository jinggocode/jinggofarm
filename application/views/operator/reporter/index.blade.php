                ...
                <?php else: ?>
                    ...
                    <tr>  
                        ...
                        <td class="text-center"> 
                            <a href="{{site_url('admin/'.$page.'/edit/'.$row->id)}}" data-toggle="tooltip" title="Perkembangan" class="btn btn-effect-ripple btn-sm btn-primary"><i class="fa fa-pencil"></i> Perkembangan</a>
                            <a href="{{site_url('admin/'.$page.'/edit/'.$row->id)}}" data-toggle="tooltip" title="Penggunaan Dana" class="btn btn-effect-ripple btn-sm btn-info"><i class="fa fa-pencil"></i> Penggunaan Dana</a>
                            <a href="{{site_url('admin/'.$page.'/edit/'.$row->id)}}" data-toggle="tooltip" title="Penjualan" class="btn btn-effect-ripple btn-sm btn-warning"><i class="fa fa-pencil"></i> Penjualan</a>
