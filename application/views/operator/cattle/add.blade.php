            ...
            <div class="block"> 
                ...
                {{form_hidden('id_kt', 1);}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input value="{{set_value('biaya')}}" type="text" id="biaya" name="biaya" class="form-control"> 
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="ekspektasi_profit_min">Ekspektasi Profit Min</label>
                        <div class="col-md-2">
                            <input value="{{set_value('ekspektasi_profit_min')}}" type="number" id="ekspektasi_profit_min" name="ekspektasi_profit_min" class="form-control"> 
                        </div>
                    </div> 
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="ekspektasi_profit_max">Ekspektasi Profit Max</label>
                        <div class="col-md-2">
                            <input value="{{set_value('ekspektasi_profit_max')}}" type="number" id="ekspektasi_profit_max" name="ekspektasi_profit_max" class="form-control"> 
                        </div>
                    </div> 
                    <div class="form-group">
