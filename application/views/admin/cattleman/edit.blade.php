...
@section('title')Edit Peternak@endsection
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="header-section">
                    <h1><a href="{{site_url('admin/cattle')}}"><i class="fa fa-arrow-left"></i></a> Edit Peternak</h1>
                </div>
            </div>
        </div>
            ...
            <div class="block">
                ...
                {{form_hidden('id', $data->id);}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input value="{{$data->umur}}" type="number" id="umur" name="umur" class="form-control">
                        </div>Tahun
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="lama_pengalaman">Pengalaman</label>
                        <div class="col-md-2">
                            <input value="{{$data->lama_pengalaman}}" type="number" id="lama_pengalaman" name="lama_pengalaman" class="form-control">
                        </div> Tahun
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <img width="300" height="1000" src="{{base_url('uploads/cattleman/img/'.$img)}}" class="image-preview img-responsive" alt="">
                        </div>
                    </div>
