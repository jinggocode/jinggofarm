        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="header-section">
                    <h1><a href="{{site_url('admin/'.$page.'/view/'.$this->uri->segment(4))}}"><i class="fa fa-arrow-left"></i></a> Tambah Laporan Perkembangan <b>{{$data->nama.' '.$data->kode_ternak}}</b></h1>
                </div>
            </div> 
        </div>  
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="block"> 
                ...
                <form action="{{site_url('admin/'.$page.'/save_grow_report/'.$this->uri->segment(4))}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                {{$csrf}}  
