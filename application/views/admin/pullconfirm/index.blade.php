...
@section('title')Data Konfirmasi Penarikan Saldo Investor@endsection
...
<div id="page-content"> 
    ...
    <div class="row" style="padding-bottom: 10px">
        <div class="col-md-12">
            <a href="{{site_url('admin/'.$page.'/history')}}" class="btn btn-primary"><i class="fa fa-history"></i> Riwayat Konfirmasi</a>  
        </div>
    </div> 
<br>
    <!-- Table Styles Block -->
                ...
                <?php else: ?>
                    ...
                    <tr>  
                        ...
                        <td class="text-center">  
                            <a href="{{site_url('admin/'.$page.'/confirm/'.$row->id)}}" data-toggle="tooltip" title="Konfirmasi Transfer" class="btn btn-effect-ripple btn-sm btn-warning" onclick="return confirm('Apakah anda yakin?')"><i class="fa fa-check"></i> Konfirmasi</a>    
                        </td>
                    </tr>
                    @endforeach 
                <?php endif ?> 
